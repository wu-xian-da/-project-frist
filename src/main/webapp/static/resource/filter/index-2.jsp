...
<html lang="zh-CN">
	<head>
		...
		<!-- 引入各种CSS样式表 -->
		<link rel="stylesheet" href="G:\MyWorkspace\project-frist\src\main\webapp\css\bootstrap.css">
		<link rel="stylesheet" href="G:\MyWorkspace\project-frist\src\main\webapp\css/font-awesome.css">
		<link rel="stylesheet" href="G:\MyWorkspace\project-frist\src\main\webapp\css/index.css">	<!-- 修改自Bootstrap官方Demon，你可以按自己的喜好制定CSS样式 -->
		<link rel="stylesheet" href="G:\MyWorkspace\project-frist\src\main\webapp\css/font-change.css">	<!-- 将默认字体从宋体换成微软雅黑（个人比较喜欢微软雅黑，移动端和桌面端显示效果比较接近） -->		
		
		<script type="text/javascript" src="G:\MyWorkspace\project-frist\src\main\webapp\js/jquery-1.12.3.min.js"></script>
		<script type="text/javascript" src="G:\MyWorkspace\project-frist\src\main\webapp\js/bootstrap.min.js"></script>
