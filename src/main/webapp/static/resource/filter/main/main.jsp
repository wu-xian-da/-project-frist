...
<html>
 ...
 <frameset rows="98,*,8"  border="7" bordercolor="#1873aa"     scrolling="No" noresize="noresize"  framespacing="0">
	<frame src="<%=basePath%>WEB-INF/views/main/top.jsp" name="topFrame" scrolling="No"  noresize="noresize" id="topFrame" />
	<frameset cols="166,*">
		<frame src="<%=basePath%>view/frame/left.jsp"   noresize="noresize" />
		<frame src="<%=basePath%>resource/images/bg-welcome.gif"  name="mainFrame" class="bg-welcome" />
	</frameset>
